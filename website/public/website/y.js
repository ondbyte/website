...
var speed = 10;
var diff = dateDiff(new Date(1994,07,20),Date.now());
var iam = 'Hi, I am Yadu(nandan).. '+diff.y+" years "+" and "+diff.d+" days old";
var iami = 0;

var desc = "A software engineer, I currently work for a Indian startup, previously donned the roles of lead software developer and software engineer positions, I like to design things mostly by code, Dart, Golang, Java, JavaScript & TypeScript are the languages I speak, always looking for better opportunities where I could play with noSQL DBs as well as relational DBs, I will containerize your apps and I'll maintain Linux <3 VM instances for you.";
var desci = 0;
